...
with timer("Cross Validation for Violent Extremism"):
    ...
    for train_index, test_index in kf.split(Features):
        with timer("Making nueral network for iteration : " + str(iteration + 1) + "   for Violent Extremism"):
            ...
            violentExtremismModel.add(GRU(100, dropout=0.2, recurrent_dropout=0.2, return_sequences=True))
            violentExtremismModel.add(GRU(32, dropout=0.2, recurrent_dropout=0.2, return_sequences=True))
            violentExtremismModel.add(GRU(16, dropout=0.2, recurrent_dropout=0.2))
...
with timer("Cross Validation for Non Violent Extremism"):
    ...
    for train_index, test_index in kf.split(Features):
        with timer("Making nueral network for iteration : " + str(iteration + 1) + "   for Non Violent Extremism"):
            ...
            nonViolentExtremismModel.add(GRU(100, dropout=0.2, recurrent_dropout=0.2, return_sequences=True))
            nonViolentExtremismModel.add(GRU(32, dropout=0.2, recurrent_dropout=0.2, return_sequences=True))
            nonViolentExtremismModel.add(GRU(16, dropout=0.2, recurrent_dropout=0.2))
...
with timer("Cross Validation for Radical Violence"):
    ...
    for train_index, test_index in kf.split(Features):
        with timer("Making nueral network for iteration : " + str(iteration + 1) + "   for Radical Violence"):
            ...
            radicalViolenceModel.add(GRU(100, dropout=0.2, recurrent_dropout=0.2, return_sequences=True))
            radicalViolenceModel.add(GRU(32, dropout=0.2, recurrent_dropout=0.2, return_sequences=True))
            radicalViolenceModel.add(GRU(16, dropout=0.2, recurrent_dropout=0.2))
            ...
            epochs = 1
            print("\nTraining until accuracy improves for epoch = ", epochs, " for iteration : ", iteration, "   forRadical Violence")
...
with timer("Cross Validation for Non Radical Violence"):
    ...
    for train_index, test_index in kf.split(Features):
        with timer("Making nueral network for iteration : " + str(iteration + 1) + "   for Non Radical Violence"):
            ...
            nonRadicalViolenceModel.add(GRU(100, dropout=0.2, recurrent_dropout=0.2, return_sequences=True))
            nonRadicalViolenceModel.add(GRU(32, dropout=0.2, recurrent_dropout=0.2, return_sequences=True))
            nonRadicalViolenceModel.add(GRU(16, dropout=0.2, recurrent_dropout=0.2))
            ...
            epochs = 1
            print("\nTraining until accuracy improves for epoch = ", epochs, " for iteration : ", iteration, "   for NonRadical Violence")
