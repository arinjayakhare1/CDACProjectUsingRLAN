...
if __name__ == '__main__':
	...
	for train_index, test_index in kf.split(Features):
		...
		fraudModel.add(Dense(1, activation='elu'))
		fraudModel.compile(loss='mean_squared_error', optimizer='sgd', metrics=[binary_accuracy])
		...
		radicalModel.add(Dense(1, activation='elu'))
		radicalModel.compile(loss='mean_squared_error', optimizer='sgd', metrics=[binary_accuracy])
		...
		violenceModel.add(Dense(1, activation='elu'))
		violenceModel.compile(loss='mean_squared_error', optimizer='sgd', metrics=[binary_accuracy])
