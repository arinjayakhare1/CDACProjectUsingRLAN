...
if __name__ == '__main__':
	...
	for train_index, test_index in kf.split(Features):
		...
		fraudModel.compile(loss='binary_crossentropy', optimizer='sgd', metrics=['accuracy'])
		...
		radicalModel.compile(loss='binary_crossentropy', optimizer='sgd', metrics=['accuracy'])
		...
		violenceModel.compile(loss='binary_crossentropy', optimizer='sgd', metrics=['accuracy'])
